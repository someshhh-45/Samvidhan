...
public class CaseExtraction {
    ...
    public void setPartiesInvolved(
            String partiesInvolved
    ) {
        this.partiesInvolved = partiesInvolved;
    }

    public String getKeyDirections() {
        return keyDirections;
    }

    public void setKeyDirections(
    ...
    public void setComplianceRequirements(
    ...
    public String getAppealConsideration() {
        return appealConsideration;
    }

    public void setAppealConsideration(
            String appealConsideration
    ) {
        this.appealConsideration =
                appealConsideration;
    }
    ...
    public void setResponsibleDepartments(
            String responsibleDepartments
    ) {
        this.responsibleDepartments =
