  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const uploadRes = await axios.post(
        'http://localhost:8083/cases/upload',
        formData,
        {
          headers: {
      ...
      const caseId = uploadRes.data.id

      // Trigger Extraction
      await axios.get(
        `http://localhost:8083/cases/process/${caseId}`
      )

      // Fetch Extraction Result
      const extractionRes = await axios.get(
        `http://localhost:8083/cases/${caseId}/extraction`
      )
    ...
    >
      ...
      >
        ...
        <div className="drop-title">
          {selectedFile
            ? selectedFile.name
            : 'Drop Constitutional Documents Here'}
        </div>
...
const [c1, r1] = useCountUp(stats.totalCases)
const [c2, r2] = useCountUp(stats.aiAccuracy)
const [c3, r3] = useCountUp(stats.departments)
  ...
  const CASES = [
    { id: 'CIS-2024-0841', dept: 'LEGAL',     date: '12 Jan 2024', status: 'verified', priority: 'high' },
    { id: 'CIS-2024-0792', dept: 'LEGAL',  date: '09 Jan 2024', status: 'pending',  priority: 'med'  },
    { id: 'CIS-2024-0755', dept: 'LEGAL',     date: '07 Jan 2024', status: 'review',   priority: 'high' },
    { id: 'CIS-2024-0718', dept: 'LEGAL',date: '04 Jan 2024', status: 'verified', priority: 'low'  },
    { id: 'CIS-2024-0703', dept: 'LEGAL',   date: '02 Jan 2024', status: 'appeal',   priority: 'med'  },
  ]
  ...
  try {
    ...
    const res = await axios.get(
      'http://localhost:8083/dashboard/stats'
    )
  ...
  const approveReview = async () => {
    try {
      ...
      await axios.post(
        `http://localhost:8083/api/reviews/${reviewTask.id}/approve`
      )
  ...
  const rejectReview = async () => {
    try {
      ...
      await axios.post(
        `http://localhost:8083/api/reviews/${reviewTask.id}/reject`
      )
      ...
      <div className="hero">
        ...
        <div className="hero-stats">
          ...
          <div className="stat-item" ref={r2}>
            <span className="stat-num">93.7%</span>
            ...
            <div className="dash-body">
              ...
              <div className="dash-main">
                <div className="kpi-row">
                  {[
                    { label: 'Total Cases',    value: '18', change: '', cls: 'gold'    },
                    { label: 'Pending Review', value: '11',    change: '', cls: 'saffron' },
                    { label: 'Verified',       value: '7', change: '', cls: 'jade'    },
                    { label: 'Escalated',      value: '0',     change: '',      cls: 'crimson' },
                  ].map(k => (
          ...
          <div className="verify-grid">
            <div className="pdf-viewer-mock">
              <div className="pdf-header">
                <span className="pdf-title">{reviewTask?.title || 'No Review'} · Source Document</span>
